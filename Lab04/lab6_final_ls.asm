...
# $f22 = 100.0f -> valor resultante das potências de 10 envolvidas
...
l.s $f22, correcao # Valor 100 das potencias de 10
...
div.s $f12,$f10,$f0
sqrt.s $f12,$f12
mul.s $f12,$f12,$f22 # Multiplicando pelo 100 resultante das potencias de 10
...
div.s $f4, $f4, $f10
sqrt.s $f12,$f4
div.s $f12,$f12,$f22 # Dividindo pelo 100 resultante das potencias de 10
